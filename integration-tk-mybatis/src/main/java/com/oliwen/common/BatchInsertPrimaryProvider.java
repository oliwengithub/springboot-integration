...
public class BatchInsertPrimaryProvider extends MapperTemplate {

    public BatchInsertPrimaryProvider (Class<?> mapperClass, MapperHelper mapperHelper) {
        super(mapperClass, mapperHelper);
    }

    public String batchInsertPrimary(MappedStatement ms) {
